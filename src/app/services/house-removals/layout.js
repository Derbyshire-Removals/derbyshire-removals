...
export const metadata = {
  ...
  alternates: {
    canonical: "https://derbyshireremovals.com/services/house-removals",
  },
  openGraph: {
    title: "Professional House Removals Services | Derbyshire Removals",
    ...
    url: "https://derbyshireremovals.com/services/house-removals",
    type: "website",
  },
};

export default function HouseRemovalsLayout({ children }) {
  return (
    <>
      {children}
    </>
