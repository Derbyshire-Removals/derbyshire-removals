...
export const metadata = {
  ...
  description: "Expert removal services in Chesterfield. Local knowledge, competitive rates, and professional moving solutions for homes and businesses across Chesterfield and surrounding areas.",
