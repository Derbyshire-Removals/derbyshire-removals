          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section className="bg-white rounded-lg shadow-md p-8 mb-8">
              ...
              <p className="text-gray-700 mb-6">
                ...
                With our extensive local knowledge and expertise, we ensure a smooth and efficient moving experience for all our Matlock customers.
              </p>
            ...
            <section className="bg-white rounded-lg shadow-md p-8 mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  "Matlock Bath", "Darley Dale", "Cromford", "Wirksworth", "Bonsall",
                  "Tansley", "Two Dales", "Bakewell", "Rowsley", "Darley Bridge"
                ].map((area, index) => (
                  <div key={index} className="flex items-center space-x-2">
