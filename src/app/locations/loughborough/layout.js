...
export const metadata = {
  title: "Removal Services in Loughborough | Derbyshire Removals",
  description: "Expert removal services in Loughborough. Local knowledge, competitive rates, and professional moving solutions for houses and businesses across Loughborough.",
  ...
  jsonLd: {
    ...
    description: "Expert removal services in Loughborough with local knowledge, competitive rates, and professional moving solutions for houses and businesses."
  }
};
