...
const Hero = () => {
  ...
  return (
    <section className="relative bg-cover bg-center py-20" style={{ backgroundImage: "url('/derbyshire-removals-background.jpg')" }}>
      <div className="container mx-auto px-4 flex flex-wrap items-center relative z-10">
        <div className="w-full lg:w-1/2 mb-10 lg:mb-0 text-white">
          <h1 className="text-4xl font-bold mb-4 text-shadow-lg">Professional Removals in Derbyshire</h1>
          <p className="text-xl mb-6 text-shadow-md">Handling with care since 1988</p>
        </div>
