      ...
      <div className="container mx-auto px-4 flex justify-end items-center text-sm">
        <div className="flex items-center space-x-4">
          <a 
            ...
            className="flex items-center hover:text-gray-300 bg-[#1A1F2C] border-2 border-[#8B5CF6] rounded-md px-2 py-1"
          >
            <Phone size={14} className="mr-1" />
            <span className="font-semibold">National: 0333 567 7001</span>
          </a>
