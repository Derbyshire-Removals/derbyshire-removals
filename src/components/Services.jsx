...
import { Truck, Package, Home, ClipboardList, Building2, Clock, Palette } from 'lucide-react';
...
const Services = () => {
  const services = [
    ...
    { icon: <Palette size={24} />, title: "Antique and Fine Arts", description: "Specialized handling for valuable and delicate items" },
  ];
